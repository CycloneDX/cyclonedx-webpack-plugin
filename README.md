...
| **`validateResults`** | `{boolean}` | `true` | Whether to validate the BOM result.<br/>Might require [optional dependencies](https://github.com/CycloneDX/cyclonedx-javascript-library#optional-dependencies). |
